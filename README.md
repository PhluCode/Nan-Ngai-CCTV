...
I have run a seed script to create your first Administrator account. You can use these credentials to log in right now:
...
user02@example.com : user02
You can log in, navigate to User Management in the sidebar, and start creating new accounts for your team!
